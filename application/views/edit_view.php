            ...
            <div class="col-md-7">
                ...
                <form action="<?php echo site_url('insertdata/adding');?>" method="post" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="m_name" class="form-control" required value="<?php echo $query->m_name ;?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-2 control-label">lastname</div>
                        <div class="col-sm-5">
                            <input type="text" name="l_name" class="form-control" required value="<?php echo $query->l_name ;?>">
                        </div>
                    </div>
                    <div class="form-group row">
